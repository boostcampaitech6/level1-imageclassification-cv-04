...
wandb.run.name = 'feat_CE_DeepHeadTinyViT_V2'
wandb.run.save()
...
def train(data_dir, model_dir, args):
    ...
    # -- model
    model = tiny_vit_21m_224(pretrained=True,num_classes=num_classes)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="tiny_vit_21m_224", help="model type (default: EfficientNetB0MultiHead)"
    ...
    parser.add_argument(
        "--criterion",
        type=str,
        default="cross_entropy", #"cross_entropy"
